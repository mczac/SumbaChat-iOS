...
class BarButtonItemWithActivity: UIBarButtonItem {
    ...
    /// Chat uses a light/system nav bar (`styleChatNavigationOverlay`), not the branded blue bar.
    /// Always use adaptive label color so icons stay visible in light and dark mode.
