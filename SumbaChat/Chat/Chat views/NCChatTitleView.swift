...
public class NCChatTitleView: UIView {
    ...
    private func commonInit() {
        ...
        // Chat uses a material nav overlay — keep title readable regardless of bubbles underneath.
    ...
    private func setTitle(_ title: String?, withSubtitle subtitle: String?) {
        ...
        if showSubtitle, let subtitle {
            ...
            attributedSubtitle.addAttribute(.foregroundColor, value: UIColor.secondaryLabel, range: rangeSubtitle)
