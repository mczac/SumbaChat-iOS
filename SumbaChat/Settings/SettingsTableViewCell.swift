...
/// Accent palette for main Settings icon tiles.
...
class SettingsTableViewCell: UITableViewCell {
    ...
    /// Colored rounded square with a white glyph.
    ...
    /// Colored rounded square with a white glyph (SF Symbol or template asset).
